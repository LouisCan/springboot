...
public class HelloEndpoint {
	...
	// JAX-RS Annotation
	@Path("/{name}")
	@ApiOperation(value = "提供一个名称", response = HelloResource.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "成功", response = HelloResource.class), @ApiResponse(code = 404, message = "找不到资源") })
